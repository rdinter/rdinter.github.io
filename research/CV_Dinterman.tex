...
\begin{minipage}{0.5\linewidth}
  \begin{tabular}{ll}
    Phone: & (919) 627-8622 \\
    % Fax: &  (919) 513-5613 \\
    Email: & \href{mailto:rdinter@ncsu.edu}{\tt rdinter@ncsu.edu} \\
...
\begin{itemize}
\item Post-Doctoral Researcher in Agribusiness, Department of Agricultural, Environmental, and Development Economics and Farm Income Enhancement Program, 2016 -- present.
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item ``Broadband, Local Employment, and Population Growth,'' (Job Market Paper).
\item ``Evaluation of USDA Broadband Loan Programs: Modeling Broadband Diffusion Across 1999 to 2008.'' \emph{Revise and Resubmit: Telecommunication Policy}
\end{itemize}

\subsection*{Works In Progress}

\begin{itemize}
\item ``Financial Stress and Farm Bankruptcies in U.S. Agriculture,'' with Ani Katchova (The Ohio State University) and Michael Harris (USDA-ERS).
...
\item Tamah Morant (Teaching) \\ Economics Graduate Programs Director \\ North Carolina State University \\ \href{mailto:tamah\_morant@ncsu.edu}{\tt tamah\_morant@ncsu.edu} \\ Office: (919) 515-4616
\end{itemize}
