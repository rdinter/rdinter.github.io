...
\begin{itemize}
\item Demko, I., Dinterman, R., Marez, M. and Jaenicke, E.C. 2017. ``U.S. Organic Trade from
...
\begin{itemize}
\item ``Financial Stress and Farm Bankruptcies in U.S. Agriculture,'' with Ani Katchova (The Ohio State University) and Michael Harris (USDA-ERS). \emph{Revise and Resubmit at Agricultural Finance Review}
\item ``Evaluating Financial Stress and Performance of Beginning Farmers during the Agricultural Downturn,'' with Ani Katchova (lead author, The Ohio State University). \emph{Submitted to Agricultural Finance Review}
...
\begin{itemize}
\item R, Matlab, ArcGIS, SAS, SQL, Stata, \LaTeX.
\end{itemize}
